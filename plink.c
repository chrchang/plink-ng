...
int32_t main(int32_t argc, char** argv) {
  ...
  */
  ...
  do {
	...
	if (!cluster.mds_dim_ct) {
	  logprint("Error: Missing --mds-plot dimension count.\n");
	  goto main_ret_INVALID_CMDLINE_A;
	}
#endif
