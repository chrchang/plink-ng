...
"  --check-sex {female max F} {male min F} {female max Y obs} {male min Y obs}\n"
"              <ycount>\n"
"  --check-sex y-only {female max Y obs} {male min Y obs}\n"
"  --impute-sex {female max F} {male min F} {female max Y obs} {male min Y obs}\n"
"               <ycount>\n"
...
"      converted to ambiguous whenever more than 0 nonmissing genotypes are\n"
"      present, and male calls are converted to ambiguous whenever fewer than 0\n"
"      are present.  These thresholds are controllable with --check-sex's\n"
"      optional 3rd and 4th numeric parameters.\n"
"    * To include Y genotype counts in the report, use the 'ycount' modifier.\n"
"    * To ONLY consider Y genotype counts, use the 'y-only' modifier.  The male\n"
"      threshold defaults to 1 instead of 0 in this case (note that this is a\n"
"      count, not a rate).\n"
