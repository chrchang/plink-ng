...
"      off (with e.g. --split-x) before using this, and that the marker set is\n"
"      in approximate linkage equilibrium.\n"
"    * By default, F estimates smaller than 0.2 yield female calls, and values\n"
"      larger than 0.8 yield male calls.  You can change these thresholds by\n"
"      passing numeric parameters to --check-sex.\n"
