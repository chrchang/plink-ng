...
int32_t write_map_or_bim(char* outname, uintptr_t* marker_exclude, uintptr_t marker_ct, char* marker_ids, uintptr_t max_marker_id_len, double* marker_cms, uint32_t* marker_pos, char* marker_alleles, uintptr_t max_marker_allele_len, uintptr_t* marker_reverse, char delim, uint32_t zero_extra_chroms, Chrom_info* chrom_info_ptr) {
...
int32_t sort_and_write_bim(uint32_t* map_reverse, uint32_t map_cols, char* outname, uintptr_t unfiltered_marker_ct, uintptr_t* marker_exclude, uintptr_t marker_ct, char* marker_ids, uintptr_t max_marker_id_len, double* marker_cms, uint32_t* marker_pos, char* marker_alleles, uintptr_t max_marker_allele_len, uintptr_t* marker_reverse, int64_t* ll_buf, uint32_t zero_extra_chroms, Chrom_info* chrom_info_ptr) {
  FILE* outfile = NULL;
...
int32_t make_bed(FILE* bedfile, uintptr_t bed_offset, char* bimname, uint32_t map_cols, char* outname, char* outname_end, uintptr_t unfiltered_marker_ct, uintptr_t* marker_exclude, uintptr_t marker_ct, char* marker_ids, uintptr_t max_marker_id_len, double* marker_cms, uint32_t* marker_pos, char* marker_alleles, uintptr_t max_marker_allele_len, uintptr_t* marker_reverse, uintptr_t unfiltered_indiv_ct, uintptr_t* indiv_exclude, uintptr_t indiv_ct, char* person_ids, uintptr_t max_person_id_len, char* paternal_ids, uintptr_t max_paternal_id_len, char* maternal_ids, uintptr_t max_maternal_id_len, uintptr_t* sex_nm, uintptr_t* sex_male, uintptr_t* pheno_nm, uintptr_t* pheno_c, double* pheno_d, char* output_missing_pheno, uint32_t map_is_unsorted, uint32_t* indiv_sort_map, uint64_t misc_flags, Two_col_params* update_chr, char* flip_subset_fname, uint32_t xmhh_exists, uint32_t nxmhh_exists, Chrom_info* chrom_info_ptr) {
  ...
  if (!map_is_unsorted) {
    memcpy(outname_end, ".bim", 5);
    retval = write_map_or_bim(outname, marker_exclude, marker_ct, marker_ids, max_marker_id_len, marker_cms, marker_pos, marker_alleles, max_marker_allele_len, marker_reverse, '\t', zero_extra_chroms, chrom_info_ptr);
    if (retval) {
      goto make_bed_ret_1;
    }
  }
...
int32_t load_fam(FILE* famfile, uint32_t buflen, uint32_t fam_cols, uint32_t tmp_fam_col_6, int32_t missing_pheno, uint32_t missing_pheno_len, uint32_t affection_01, uintptr_t* unfiltered_indiv_ct_ptr, char** person_ids_ptr, uintptr_t* max_person_id_len_ptr, char** paternal_ids_ptr, uintptr_t* max_paternal_id_len_ptr, char** maternal_ids_ptr, uintptr_t* max_maternal_id_len_ptr, uintptr_t** sex_nm_ptr, uintptr_t** sex_male_ptr, uint32_t* affection_ptr, uintptr_t** pheno_nm_ptr, uintptr_t** pheno_c_ptr, double** pheno_d_ptr, uintptr_t** founder_info_ptr, uintptr_t** indiv_exclude_ptr) {
  ...
  if (fam_cols & FAM_COL_34) {
    ...
    fill_ulong_one(founder_info, unfiltered_indiv_ctl);
  }
...
int32_t lgen_to_bed(char* lgen_namebuf, char* outname, char* outname_end, char missing_geno, int32_t missing_pheno, uint64_t misc_flags, uint32_t lgen_modifier, char* lgen_reference_fname, Chrom_info* chrom_info_ptr) {
  ...
  for (ujj = 0; ujj < uii; ujj++) {
    if (!marker_alleles[ujj]) {
      marker_alleles[ujj] = &(one_char_strs[(((unsigned char)missing_geno) - ' ') * 2]);
    }
  }
  uii = 0;
  marker_idx = 0;
...
uint32_t recode_load_to(unsigned char* loadbuf, FILE* bedfile, uintptr_t bed_offset, uintptr_t unfiltered_marker_ct, uintptr_t marker_idx, uintptr_t marker_idx_end, uintptr_t* marker_exclude, uintptr_t* marker_uidx_ptr, uintptr_t unfiltered_indiv_ct4) {
...
void init_recode_cmax(char* allele1, uintptr_t max_marker_allele_len, uint32_t do_reverse, char** cur_mk_allelesx, uint32_t* cmalen, char delimiter, char delim2) {
  char* allele2 = &(allele1[max_marker_allele_len]);
  ...
  cmalen[0] = alen1 * 2 + 2;
  if (do_reverse) {
    cmaptr = memcpyax(cur_mk_allelesx[2], allele2, alen2, delim2);
    memcpyx(cmaptr, allele1, alen1, delimiter);
  } else {
...
uint32_t write_ped_lines(FILE* outfile, unsigned char* loadbuf, uintptr_t* marker_exclude, uintptr_t* marker_reverse, uintptr_t marker_uidx_start, uintptr_t marker_ct, uintptr_t unfiltered_indiv_ct4, uintptr_t* indiv_exclude, uintptr_t* indiv_uidx_ptr, uintptr_t indiv_idx_start, uintptr_t indiv_idx_end, uint32_t recode_compound, char* mk_alleles, uint32_t max_marker_allele_len, char delimiter, char delim2, char* person_ids, uintptr_t max_person_id_len, char* paternal_ids, uintptr_t max_paternal_id_len, char* maternal_ids, uintptr_t max_maternal_id_len, uintptr_t* sex_nm, uintptr_t* sex_male, uintptr_t* pheno_nm, uintptr_t* pheno_c, double* pheno_d, char output_missing_geno, char* output_missing_pheno, char* writebuf) {
  ...
  for (indiv_idx = indiv_idx_start; indiv_idx < indiv_idx_end; indiv_idx++) {
    indiv_uidx = next_non_set_unsafe(indiv_exclude, indiv_uidx);
	...
	if (ucc) {
	  if (ucc == 2) {
	    ...
	    *wbufptr = mk_alleles[2 * marker_uidx + 1];
	    ...
	    ucc2 = IS_SET(marker_reverse, marker_uidx);
	...
	if (ucc) {
	  if (ucc == 3) {
	    ...
	    ucc2 = IS_SET(marker_reverse, marker_uidx);
	    wbufptr = strcpyax(wbufptr, &(mk_alleles[(2 * marker_uidx + ucc2) * max_marker_allele_len]), delim2);
	    wbufptr = strcpyax(wbufptr, &(mk_alleles[(2 * marker_uidx + (1 ^ ucc2)) * max_marker_allele_len]), delimiter);
	  } else {
...
int32_t recode(uint32_t recode_modifier, FILE* bedfile, uintptr_t bed_offset, FILE* famfile, char* outname, char* outname_end, char* recode_allele_name, uintptr_t unfiltered_marker_ct, uintptr_t* marker_exclude, uintptr_t marker_ct, uintptr_t unfiltered_indiv_ct, uintptr_t* indiv_exclude, uintptr_t indiv_ct, char* marker_ids, uintptr_t max_marker_id_len, double* marker_cms, char* marker_alleles, uintptr_t max_marker_allele_len, uint32_t* marker_pos, uintptr_t* marker_reverse, char* person_ids, uintptr_t max_person_id_len, char* paternal_ids, uintptr_t max_paternal_id_len, char* maternal_ids, uintptr_t max_maternal_id_len, uintptr_t* sex_nm, uintptr_t* sex_male, uintptr_t* pheno_nm, uintptr_t* pheno_c, double* pheno_d, char missing_geno, char output_missing_geno, char* output_missing_pheno, uint64_t misc_flags, uint32_t xmhh_exists, uint32_t nxmhh_exists, Chrom_info* chrom_info_ptr) {
  ...
  if (recode_modifier & (RECODE_TRANSPOSE | RECODE_VCF)) {
    ...
    *wbufptr++ = '\n';
    ...
    if (wkspace_alloc_c_checked(&cur_mk_allelesx_buf, ulii * 4) ||
        wkspace_alloc_c_checked(&writebuf3, ulii * indiv_ct + 1)) {
      goto recode_ret_NOMEM;
    }
    ...
    if (wkspace_alloc_c_checked(&writebuf, (ulii + max_marker_id_len + max_person_id_len) * indiv_ct)) {
      goto recode_ret_NOMEM;
    }
	...
	goto recode_ret_INVALID_FORMAT;
      ...
      if ((max_marker_allele_len == 1) || recode_12) {
        ulii = 4;
      } else {
	ulii = 2 * max_marker_allele_len;
      }
    ...
    if (!(recode_modifier & (RECODE_A | RECODE_AD))) {
      // common initialization between normal --recode, --recode HV, and
      // --recode structure
      if ((max_marker_allele_len == 1) || recode_12) {
	if (recode_modifier & RECODE_COMPOUND) {
  ...
  if (recode_12) {
    ...
    for (marker_idx = 0; marker_idx < marker_ct; marker_uidx++, marker_idx++) {
      ...
      ucc = IS_SET(marker_reverse, marker_uidx);
      mk_alleles[2 * marker_uidx] = '1' + ucc;
      mk_alleles[2 * marker_uidx + 1] = '2' - ucc;
    }
    max_marker_allele_len = 1;
  } else {
    mk_alleles = marker_alleles;
    if ((max_marker_allele_len > 1) && (!(recode_modifier & (RECODE_BEAGLE | RECODE_FASTPHASE | RECODE_FASTPHASE_1CHR | RECODE_LGEN | RECODE_LGEN_REF | RECODE_VCF)))) {
  ...
  if (recode_modifier & RECODE_TRANSPOSE) {
	...
	memset(writebuf, delimiter, indiv_ct * 4 - 1);
      ...
      cur_mk_alleles[2] = output_missing_geno;
      cur_mk_alleles[3] = output_missing_geno;
    } else {
      if ((recode_modifier & (RECODE_TAB | RECODE_DELIMX)) == RECODE_TAB) {
	...
	*wbufptr++ = delimiter;
	...
	if (max_marker_allele_len == 1) {
	  ...
	  cur_mk_alleles[0] = ucc;
	  cur_mk_alleles[1] = ucc;
	  if (IS_SET(marker_reverse, marker_uidx)) {
	    cur_mk_alleles[4] = ucc2;
	    cur_mk_alleles[5] = ucc;
	  } else {
	    cur_mk_alleles[4] = ucc;
	    cur_mk_alleles[5] = ucc2;
	  }
	  cur_mk_alleles[6] = ucc2;
	  cur_mk_alleles[7] = ucc2;
	  ...
	  while (1) {
		...
		ulii = cur_word & 3;
		*wbufptr = cur_mk_alleles[2 * ulii];
		wbufptr[2] = cur_mk_alleles[2 * ulii + 1];
		wbufptr = &(wbufptr[4]);
		cur_word >>= 2;
	      }
	    }
	  ...
	  init_recode_cmax(&(mk_alleles[2 * marker_uidx * max_marker_allele_len]), max_marker_allele_len, IS_SET(marker_reverse, marker_uidx), cur_mk_allelesx, cmalen, delimiter, delim2);
          ulptr = loadbuf_collapsed;
	  ulptr_end = &(loadbuf_collapsed[indiv_ct / BITCT2]);
	  shiftmax = BITCT2;
	  while (1) {
...
, outfile)) {
	...
	*wbufptr++ = '\t';
	...
	ulii = IS_SET(marker_reverse, marker_uidx);
	ucc = '1' - ulii;
	ucc2 = '0' + ulii;
	cur_mk_allelesx[0][1] = ucc;
	cur_mk_allelesx[0][3] = ucc;
	cur_mk_allelesx[3][1] = ucc2;
	cur_mk_allelesx[3][3] = ucc2;
	if (max_marker_allele_len == 1) {
	  *wbufptr++ = replace_if_zero(mk_alleles[2 * marker_uidx + 1 - ulii], '.');
	  *wbufptr++ = '\t';
	  *wbufptr++ = replace_if_zero(mk_alleles[2 * marker_uidx + ulii], '.');
	} else {
	  wbufptr = strcpyax(wbufptr, replace_if_zstr(&(mk_alleles[(2 * marker_uidx + 1 - ulii) * max_marker_allele_len]), "0"), '\t');
	  wbufptr = strcpya(wbufptr, replace_if_zstr(&(mk_alleles[(2 * marker_uidx + ulii) * max_marker_allele_len]), "0"));
	}
...
, outfile)) {
	...
	*cptr++ = '\t';
	...
	goto recode_ret_READ_FAIL;
      ...
      if (is_haploid && set_hh_missing) {
	haploid_fix(xmhh_exists, nxmhh_exists, indiv_include2, indiv_male_include2, 1, is_x, is_y, (unsigned char*)(&cur_word));
      }
      aptr = uint32_writex(cptr, marker_pos[marker_uidx], '\t');
      if (cur_word) {
	if (cur_word == 3) {
	  *aptr++ = mk_alleles[2 * marker_uidx + 1];
	  *aptr++ = mk_alleles[2 * marker_uidx + 1];
	} else if (cur_word == 2) {
	  ulii = IS_SET(marker_reverse, marker_uidx);
	  *aptr++ = mk_alleles[2 * marker_uidx + 1 - ulii];
	  *aptr++ = mk_alleles[2 * marker_uidx + ulii];
	} else {
	  aptr = memseta(aptr, '-', 2);
	}
      } else {
	*aptr++ = mk_alleles[2 * marker_uidx];
	*aptr++ = mk_alleles[2 * marker_uidx];
      }
      fputs(&(marker_ids[marker_uidx * max_marker_id_len]), outfile);
      if (ucc2 && (cur_word != 1)) {
	...
	fwrite(tbuf, 1, wbufptr - tbuf, outfile2);
	  ...
	  cur_mk_allelesx[0][3] = ucc;
	  if (IS_SET(marker_reverse, marker_uidx)) {
	    cur_mk_allelesx[2][1] = ucc2;
	    cur_mk_allelesx[2][3] = ucc;
	    putc(replace_if_zero(ucc2, 'X'), outfile2);
	    putc('\t', outfile2);
            putc(replace_if_zero(ucc, 'X'), outfile2);
	  } else {
	    cur_mk_allelesx[2][1] = ucc;
	    cur_mk_allelesx[2][3] = ucc2;
            putc(replace_if_zero(ucc, 'X'), outfile2);
	    putc('\t', outfile2);
	    putc(replace_if_zero(ucc2, 'X'), outfile2);
	  }
	  ...
	  aptr = &(mk_alleles[2 * marker_uidx * max_marker_allele_len]);
	  aptr2 = &(aptr[max_marker_allele_len]);
	  alen = strlen(aptr);
          alen2 = strlen(aptr2);
	  ...
	  cmalen[0] = 2 * alen + 2;
          if (IS_SET(marker_reverse, marker_uidx)) {
            wbufptr = memcpyax(&(cur_mk_allelesx[2][1]), aptr2, alen2, ' ');
            memcpy(wbufptr, aptr, alen);
	...
	*wbufptr++ = '\n';
	if (fwrite_checked(writebuf3, wbufptr - writebuf3, outfile)) {
	  goto recode_ret_WRITE_FAIL;
	}
      }
      if (pct < 100) {
	...
	goto recode_ret_1;
      ...
      if (recode_load_to(loadbuf, bedfile, bed_offset, chrom_info_ptr->chrom_file_order_marker_idx[chrom_fo_idx + 1], 0, ulii, marker_exclude, &marker_uidx, unfiltered_indiv_ct4)) {
	goto recode_ret_READ_FAIL;
      }
      if (set_hh_missing) {
	...
	marker_idx = 0;
	  ...
	  do {
            ucc = (((*bufptr) >> shiftval) & 3) | (4 * IS_SET(marker_reverse, uidx_cur));
            *aptr++ = "0?011?00"[ucc];
	    *aptr2++ = "0?111?10"[ucc];
	    bufptr = &(bufptr[unfiltered_indiv_ct4]);
	...
	if (max_marker_allele_len == 1) {
	  ...
	  if (lgen_ref) {
	    if ((cur_mk_alleles[3] != missing_geno) || (cur_mk_alleles[2] != missing_geno)) {
	      fputs(wbufptr, outfile2);
	      if (cur_mk_alleles[3] != missing_geno) {
		putc(delimiter, outfile2);
		putc(cur_mk_alleles[3], outfile2);
	      }
	      if (cur_mk_alleles[2] != missing_geno) {
		putc(delimiter, outfile2);
		putc(cur_mk_alleles[2], outfile2);
	      }
	      if (putc_checked('\n', outfile2)) {
		goto recode_ret_WRITE_FAIL;
	      }
	    }
	    ref_word = 3 * (1 ^ IS_SET(marker_reverse, marker_uidx));
	  }
	  *cptr++ = *cur_mk_alleles;
	  if (!recode_compound) {
	    *cptr++ = delim2;
	  ...
	  *cptr++ = '\n';
	  ...
	  cptr[alen - ulii] = output_missing_geno;
	  cptr[alen - 2] = output_missing_geno;
	  ...
	  memcpy(&(tbuf[alen]), tbuf, ulii);
	  memcpy(&(tbuf[2 * alen]), tbuf, ulii);
	  memcpy(&(tbuf[3 * alen]), tbuf, ulii);
	  cur_mk_allelesx[1][0] = output_missing_geno;
	  cur_mk_allelesx[1][1] = delim2;
	  cur_mk_allelesx[1][2] = output_missing_geno;
	  cur_mk_allelesx[1][3] = '\n';
	  init_recode_cmax(&(mk_alleles[2 * marker_uidx * max_marker_allele_len]), max_marker_allele_len, IS_SET(marker_reverse, marker_uidx), cur_mk_allelesx, cmalen, '\n', delim2);
	  cmalen[0] += ulii;
	  cmalen[1] = 4 + ulii;
	  cmalen[2] += ulii;
	  cmalen[3] += ulii;
	  if (lgen_ref) {
	    ref_word = IS_SET(marker_reverse, marker_uidx);
	    aptr = &(mk_alleles[(2 * marker_uidx + 1 - ref_word) * max_marker_allele_len]);
	    aptr2 = &(mk_alleles[(2 * marker_uidx + ref_word) * max_marker_allele_len]);
	...
	while (1) {
	  while (ulptr < ulptr_end) {
	    ...
	    for (; indiv_idx < shiftmax; indiv_idx++) {
	      ulii = cur_word & 3;
	      if (ulii != ref_word) {
		wbufptr = strcpya(wbufptr, &(person_ids_collapsed[indiv_idx * max_person_id_len]));
		wbufptr = memcpya(wbufptr, &(tbuf[ulii * alen]), cmalen[ulii]);
	      }
	      cur_word >>= 2;
	    }
	    shiftmax += BITCT2;
	...
	fputs(cptr, outfile);
	putc('_', outfile);
	if (putc_checked(cc, outfile)) {
	  goto recode_ret_WRITE_FAIL;
	}
	if (recode_modifier & RECODE_AD) {
	  putc(' ', outfile);
	  fputs(cptr, outfile);
	  if (fputs_checked("_HET", outfile)) {
	    goto recode_ret_WRITE_FAIL;
	  }
	}
      } else {
	...
	if (recode_modifier & RECODE_A) {
	  fprintf(outfile, " %s_%s", cptr, aptr);
	} else {
	  fprintf(outfile, " %s_%s %s_HET", cptr, aptr, cptr);
	}
	if (ferror(outfile)) {
	  goto recode_ret_WRITE_FAIL;
	}
    ...
    logprintb();
    if (recode_load_to(loadbuf, bedfile, bed_offset, unfiltered_marker_ct, 0, marker_ct, marker_exclude, &marker_uidx, unfiltered_indiv_ct4)) {
      goto recode_ret_READ_FAIL;
    }
    if (set_hh_missing) {
      haploid_fix_multiple(marker_exclude, 0, marker_ct, chrom_info_ptr, xmhh_exists, nxmhh_exists, indiv_include2, indiv_male_include2, unfiltered_indiv_ct, unfiltered_indiv_ct4, loadbuf);
    }
    // should handle reverse here
    fputs("0%", stdout);
    indiv_uidx = 0;
    indiv_idx = 0;
    for (pct = 1; pct <= 100; pct++) {
	  ...
	  do {
		...
		if (ucc) {
		  if (ucc == 2) {
		    ...
		    *wbufptr++ = '0' + 2 * IS_SET(marker_reverse, marker_uidx);
		  } else {
		    *wbufptr++ = 'N';
		    *wbufptr++ = 'A';
		  }
		} else {
		  *wbufptr++ = '2' - 2 * IS_SET(marker_reverse, marker_uidx);
		}
	      }
	      *wbufptr++ = delimiter;
	      bufptr = &(bufptr[unfiltered_indiv_ct4]);
	...
	if (max_marker_allele_len == 1) {
	  ...
	  init_recode_cmax(&(mk_alleles[2 * marker_uidx * max_marker_allele_len]), max_marker_allele_len, IS_SET(marker_reverse, marker_uidx), cur_mk_allelesx, cmalen, '\0', delimiter);
	}
	...
	if (rlist) {
	  ...
	  ucc2 = 3 * (1 ^ IS_SET(marker_reverse, marker_uidx));
	  for (indiv_idx = 0; indiv_idx < indiv_ct; indiv_idx++) {
	    indiv_uidx = next_non_set_unsafe(indiv_exclude, indiv_uidx);
	  ...
	  *(writebuflp[2]++) = '\n';
	  *(writebuflp[3]++) = '\n';
	  ulii = 3 * IS_SET(marker_reverse, marker_uidx);
    ...
    memcpy(writebuf2, " 1 1 0 0 1 2 2 2 2 2 0 0 1 2 1 1", 32);
    for (pct = 1; pct <= 100; pct++) {
      loop_end = (((uint64_t)pct) * indiv_ct) / 100;
      for (; indiv_idx < loop_end; indiv_idx++) {
	indiv_uidx = next_non_set_unsafe(indiv_exclude, indiv_uidx);
	...
	shiftval = (indiv_uidx % 4) * 2;
        cptr = &(person_ids[indiv_uidx * max_person_id_len]);
        aptr = (char*)memchr(cptr, '\t', max_person_id_len);
        if (fputs_checked(&(aptr[1]), outfile)) {
	  goto recode_ret_WRITE_FAIL;
	}
	memcpy(tbuf, cptr, (uintptr_t)(aptr - cptr));
	...
	tbuf[0] = ' ';
        ...
        fwrite(tbuf, 1, (uintptr_t)(wbufptr - tbuf), outfile);
	marker_uidx = 0;
	wbufptr = writebuf;
        for (marker_idx = 0; marker_idx < marker_ct; marker_idx++) {
	  marker_uidx = next_non_set_unsafe(marker_exclude, marker_uidx);
	    ...
	    wbufptr = memcpya(wbufptr, &(writebuf2[16 + 4 * ucc]), 4);
	  }
	  bufptr = &(bufptr[unfiltered_indiv_ct4]);
          marker_uidx++;
	}
	fwrite(writebuf, 1, (uintptr_t)(wbufptr - writebuf), outfile);
	if (putc_checked('\n', outfile)) {
          goto recode_ret_WRITE_FAIL;
	}
        indiv_uidx++;
    ...
    for (pct = 1; pct <= 100; pct++) {
      loop_end = (((uint64_t)pct) * indiv_ct) / 100;
      if (write_ped_lines(outfile, loadbuf, marker_exclude, marker_reverse, 0, marker_ct, unfiltered_indiv_ct4, indiv_exclude, &indiv_uidx, indiv_idx, loop_end, recode_compound, mk_alleles, max_marker_allele_len, delimiter, delim2, person_ids, max_person_id_len, paternal_ids, max_paternal_id_len, maternal_ids, max_maternal_id_len, sex_nm, sex_male, pheno_nm, pheno_c, pheno_d, output_missing_geno, output_missing_pheno, writebuf)) {
	goto recode_ret_WRITE_FAIL;
      }
      indiv_idx = loop_end;
      if (pct < 100) {
  ...
  if (!(recode_modifier & (RECODE_TRANSPOSE | RECODE_23 | RECODE_A | RECODE_AD | RECODE_BEAGLE | RECODE_BIMBAM | RECODE_BIMBAM_1CHR | RECODE_FASTPHASE | RECODE_FASTPHASE_1CHR | RECODE_HV | RECODE_HV_1CHR | RECODE_LIST | RECODE_STRUCTURE | RECODE_VCF))) {
    ...
    retval = write_map_or_bim(outname, marker_exclude, marker_ct, marker_ids, max_marker_id_len, marker_cms, marker_pos, NULL, 0, NULL, ((recode_modifier & (RECODE_TAB | RECODE_DELIMX)) == RECODE_DELIMX)? ' ' : '\t', zero_extra_chroms, chrom_info_ptr);
    if (retval) {
      goto recode_ret_1;
    }
  }
...
int32_t merge_bim_scan(char* bimname, uint32_t is_binary, uintptr_t* max_marker_id_len_ptr, uintptr_t* max_marker_allele_len_ptr, Ll_entry2** htable2, uintptr_t* topsize_ptr, uint64_t* tot_marker_ct_ptr, uint32_t* cur_marker_ct_ptr, uint32_t* position_warning_ct_ptr, Ll_str** non_biallelics_ptr, uint32_t allow_extra_chroms, Chrom_info* chrom_info_ptr) {
  uintptr_t max_marker_id_len = *max_marker_id_len_ptr;
  uintptr_t max_marker_allele_len = *max_marker_allele_len_ptr;
  uintptr_t topsize = *topsize_ptr;
...
int32_t merge_main(char* bedname, char* bimname, char* famname, uint32_t tot_indiv_ct, uint32_t tot_marker_ct, uint32_t dedup_marker_ct, uint32_t start_marker_idx, uint32_t marker_window_size, char* marker_alleles, uintptr_t max_marker_allele_len, char* marker_ids, uintptr_t max_marker_id_len, char* person_ids, uintptr_t max_person_id_len, uint32_t merge_nsort, uint32_t* indiv_nsmap, uint32_t* flex_map, uint32_t* marker_map, char* idbuf, unsigned char* readbuf, unsigned char* writebuf, uint32_t merge_mode, uintptr_t* markbuf, FILE* outfile, uint64_t* diff_total_overlap_ptr, uint64_t* diff_not_both_genotyped_ptr, uint64_t* diff_discordant_ptr, uint32_t ped_buflen, unsigned char* bmap_raw) {
...
int32_t merge_datasets(char* bedname, char* bimname, char* famname, char* outname, char* outname_end, char* mergename1, char* mergename2, char* mergename3, uint64_t calculation_type, uint32_t merge_type, uint32_t indiv_sort, uint64_t misc_flags, Chrom_info* chrom_info_ptr) {
  ...
  mlpos = 0;
  do {
    retval = merge_bim_scan(mergelist_bim[mlpos], (mergelist_fam[mlpos])? 1 : 0, &max_marker_id_len, &max_marker_allele_len, htable2, &topsize, &ullxx, &cur_marker_ct, &position_warning_ct, &non_biallelics, allow_extra_chroms, chrom_info_ptr);
    if (retval) {
      goto merge_datasets_ret_1;
    }
  ...
  if (merge_post_msort_update_maps(marker_ids, max_marker_id_len, marker_map, pos_buf, ll_buf, chrom_start, chrom_id, chrom_ct, &dedup_marker_ct, merge_equal_pos, marker_alleles, max_marker_allele_len, chrom_info_ptr)) {
    goto merge_datasets_ret_INVALID_FORMAT;
  }
  if (!dedup_marker_ct) {
  ...
  if (merge_mode < 6) {
	...
	for (; ujj < uii; ujj++) {
	  ...
	  fprintf(outfile, "\t%s\t%g\t%u\t%c\t%c\n", &(marker_ids[map_reverse[ujj] * max_marker_id_len]), marker_cms[ujj], pos_buf[ujj], cc, cc2);
	  if (ferror(outfile)) {
	    goto merge_datasets_ret_WRITE_FAIL;
	  }
	}
