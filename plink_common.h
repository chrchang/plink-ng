...
#define MISC_UPDATE_ALLELES_ALLOW_SWAP 0x400000000LLU
...
#define FILTER_SET_MISSING_VAR_IDS 0x10000LLU
#define FILTER_TAIL_PHENO 0x20000LLU
#define FILTER_ZERO_CMS 0x40000LLU
