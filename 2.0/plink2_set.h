...
pglerr_t extract_exclude_range(const char* fname, const chr_info_t* cip, const uint32_t* variant_bp, uint32_t raw_variant_ct, uint32_t do_exclude, uintptr_t* variant_include, uint32_t* variant_ct_ptr);
