...
static PREFER_CONSTEXPR char ver_str[] = "PLINK v2.0.0-a.6.31.a"
#ifdef NOLAPACK
  "NL"
...
#ifdef HAS_CONSTEXPR
static_assert(CompileTimeSlen(ver_str) + CompileTimeSlen(ver_str2) == 160, "ver_str/ver_str2 needs to be updated.");
#endif
