...
int main(int argc, char** argv) {
...

  {
    ...
    const uint32_t batch_job = (adjust_file_info.fname != nullptr) || (pc.gwas_ssf_info.fname != nullptr) || (pc.gwas_ssf_info.list_fname != nullptr) || (simulate_fname != nullptr) || (meta_info.fnames != nullptr);
