...
FLAGSET_DEF_START()
  ...
  kfMissingRptScolNmiss = (1 << 7),
  kfMissingRptScolNmissHh = (1 << 8),
  kfMissingRptScolHethap = (1 << 9),
  kfMissingRptScolNobs = (1 << 10),
  kfMissingRptScolFmiss = (1 << 11),
  kfMissingRptScolFmissHh = (1 << 12),
  ...
  kfMissingRptVcolChrom = (1 << 13),
  kfMissingRptVcolPos = (1 << 14),
  kfMissingRptVcolRef = (1 << 15),
  kfMissingRptVcolAlt1 = (1 << 16),
  kfMissingRptVcolAlt = (1 << 17),
  kfMissingRptVcolNmiss = (1 << 18),
  kfMissingRptVcolNmissHh = (1 << 19),
  kfMissingRptVcolHethap = (1 << 20),
  kfMissingRptVcolNobs = (1 << 21),
  kfMissingRptVcolFmiss = (1 << 22),
  kfMissingRptVcolFmissHh = (1 << 23),
  kfMissingRptVcolFhethap = (1 << 24),
