...
run $1/plink2 $2 --vcf 1kg_phase3_chr21_start.vcf.gz --out plink2_data
run $1/plink2 $2 --pfile plink2_data --export vcf --out plink2_data
...
run $1/plink2 $2 --pfile plink2_data --remove remove.txt --export vcf --out plink2_pruned
...
run $1/plink2 $2 --pfile plink2_data --remove remove.txt --make-pgen --out plink2_pruned

# this exercises different subsetting code paths
run $1/plink2 $2 --pfile plink2_pruned --export vcf --out plink2_pruned2
...
run $1/plink2 $2 --pfile plink2_data --keep sparse.fam --extract extract.txt --export vcf --out plink2_sparse

# test phased genotype sorting code path
run $1/plink2 $2 --pfile plink2_data --keep sparse.fam --indiv-sort f sparse.fam --extract extract.txt --make-pgen --out plink2_sparse2
run $1/plink2 $2 --vcf plink2_sparse.vcf --make-pgen --out plink2_sparse
