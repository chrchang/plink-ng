...
"    chrom/pos/ref/alt to the .lmendel[.zst] output file.\n\n"
    ...
    HelpPrint("cmh\0mh\0bd\0mh2\0homog\0", &help_ctrl, 1,
"  --cmh [\'zs\'] [\'cols=\'<column set descriptor>] [<stratum phenotype name>]\n"
"    (alias: --mh)\n"
"    Cochran-Mantel-Haenszel 2x2xK test for case/control association,\n"
"    stratified by a categorical phenotype or covariate.  Reports the CMH\n"
"    statistic, the Mantel-Haenszel odds ratio, and the\n"
"    Robins-Breslow-Greenland standard error of its logarithm.\n"
"    * The strata come from a categorical phenotype or covariate; --within\n"
"      loads one from a PLINK 1.x cluster file.  The name is only needed when\n"
"      more than one categorical phenotype/covariate is loaded.\n"
"    * A stratum without both cases and controls carries no information and\n"
"      is dropped, with a count in the log.\n"
"    * The confidence interval defaults to 95%; --ci changes it.\n"
"    * Non-autosomal variants are excluded, and multiallelic variants are\n"
"      collapsed to REF vs. non-REF.\n"
"    Supported column sets are:\n"
"      chrom: Chromosome ID.\n"
"      pos: Base-pair coordinate.\n"
"      (ID is always present, and positioned here.)\n"
...
"                    and the REF column is present.\n"
"      provref: Force provref column even if all-\'N\'.\n"
"      a1: Allele the counts are keyed on.\n"
"      a1freq: A1 frequency over the strata that contributed.\n"
"      nobs: Number of (nonmissing) genotype observations.\n"
"      chisq: CMH test statistic.\n"
"      p: CMH p-value.\n"
"      or: Mantel-Haenszel odds ratio.\n"
"      se: Robins-Breslow-Greenland standard error of log(OR).\n"
"      ci: Confidence interval for the odds ratio.\n"
"      bdchisq: Breslow-Day test statistic for homogeneity of the\n"
"               per-stratum odds ratios.\n"
"      bdp: Breslow-Day p-value.\n"
"    The default is chrom,pos,a1,a1freq,nobs,chisq,p,or,se,ci; add\n"
"    bdchisq and bdp for the Breslow-Day test, which PLINK 1.x spelled --bd.\n\n"
               );
