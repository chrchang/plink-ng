...
"    (actually, only A, AD, Av, bcf, bgen-1.x, bimbam, eig, haps, hapslegend,\n"
...
"    * 'bimbam': Regular BIMBAM format (.geno.txt + .pheno.txt + .pos.txt).\n"
"               Does not support multicharacter allele codes.  The .pheno.txt\n"
"               file has one column per loaded phenotype.\n"
