...
"    * 'beagle-unphased': Single .dat file in BEAGLE 3.3's unphased marker\n"
"                        format, with one header line per loaded phenotype\n"
"                        ('A' case/control, 'T' quantitative, 'C' otherwise).\n"
"                        Multiallelic variants are supported, up to BEAGLE's\n"
"                        limit of 128 alleles.\n"
"    * 'beagle-phased': As above, into a .dat.phased file; requires every\n"
"                       heterozygous call to be phased.\n"
...
"    * 'mgf': BIMBAM mean genotype format: a .mgf file of ALT dosages, plus\n"
"           .pos.txt, plus .pheno.txt when a quantitative phenotype is loaded\n"
"           (one column per such phenotype).  Tab-delimited by default;\n"
"           'spaces' switches to spaces, and 'bgz' block-gzips the .mgf.\n"
"           Does not support multicharacter allele codes, and rejects commas\n"
"           and semicolons in variant IDs and allele codes.\n"
