...
"    --keep-founders if this is a problem.  Heterozygous haploid calls and mixed\n"
"    chrM calls are treated as missing.\n"
"    Supported column sets are:\n"
"      chrom: Chromosome ID.\n"
"      pos: Base-pair coordinate.\n"
"      (ID is always present, and positioned here.)\n"
...
"      modifier).\n"
"      For now, this requires you to explicitly tell --glm to add the 'provref',\n"
"      'omitted' and 'a1freq' columns to its default output.  These three\n"
"      columns will be added to the default column set in a future build.\n"
"    * To postprocess some preexisting file(s), use file= and/or file-list= .\n"
"      Note that these files must contain the not-yet-default 'a1freq' column,\n"
"      along with most default columns.  (This is why PLINK 1.x\n"
"      --linear/--logistic results are not supported.)\n"
...
"                                  (-9, -10] is present, PLINK 2 prints a\n"
"                                  warning (upgraded to an error in a6 when -9\n"
"                                  also present).\n"
...
"    this is now opt-in instead of opt-out; --keep-allele-order is no longer\n"
