...
"      --write-snplist.  Add the 'allow-dups' modifier to suppress that.\n\n"
    ...
    HelpPrint("qfam\0qfam-parents\0qfam-between\0qfam-total\0", &help_ctrl, 1,
"  --qfam ['mperm='<value>] ['perm-count'] ['emp-se'] ['zs']\n"
"         ['cols='<col set desc>]\n"
"  --qfam-parents ...\n"
"  --qfam-between ...\n"
"  --qfam-total ...\n"
"    QFAM family-based association test for a quantitative phenotype.  Each\n"
"    family, sibship or unrelated singleton gets a between-family genotype\n"
"    score B (its mean ALT dosage, centered at 1), and each sample gets a\n"
"    within-family deviate W = (own ALT dosage - 1) - B.  --qfam and\n"
"    --qfam-parents regress the phenotype on W (the latter also keeps founder\n"
"    parents), --qfam-between on B, and --qfam-total on B + W.\n"
"    * Mendel errors are set to missing first.\n"
"    * Only the permutation p-value is interpretable; the asymptotic one\n"
"      ignores the family structure, and is reported as RAW_P for that reason.\n"
"      Permutation is adaptive by default (see --aperm); 'mperm='<value> runs a\n"
"      fixed number of permutations instead.  Note that the method does not\n"
"      support a proper max(T) test, so this is not a max(T) permutation.\n"
"    * 'perm-count' reports permutation counts instead of p-values, and\n"
"      'emp-se' adds the permutation mean and standard error of BETA.\n"
"    Supported column sets are:\n"
"      chrom: Chromosome ID.\n"
"      pos: Base-pair coordinate.\n"
"      ref: Reference allele.\n"
...
"      nind: Number of samples in the regression.\n"
"      beta: Regression coefficient.\n"
"      stat: T-statistic.\n"
"      rawp: Asymptotic p-value; see the warning above.\n"
"      emp1: Empirical p-value.\n"
"      np: Number of permutations performed.\n"
"    The default is chrom,pos,maybeprovref,a1,test,nind,beta,stat,rawp,emp1,np.\n\n"
               );
