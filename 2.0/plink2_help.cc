...
"      The penalized fit's Wald statistics use logistf's covariance estimate\n"
"      (the inverse information matrix with each sample weighted by 1 + its\n"
"      leverage, as for 'firth' on case/control phenotypes), and its omnibus\n"
"      test is the penalized likelihood-ratio test:\n"
"      the null model maximizes the same penalized likelihood (whose penalty\n"
"      involves the genotype column) with the genotype coefficients fixed at\n"
"      zero, so it is refitted for every variant.  'firth-residualize' and\n"
"      'single-prec-cc' do not apply to multinomial regression.\n"
