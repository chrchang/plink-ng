...
"    * --homozyg-min-af is required, and has no default.  Variants with minor\n"
"      allele frequency below it are excluded, since rare variants are\n"
"      homozygous in nearly everyone and pad out runs the same way.  0.05 is\n"
"      a reasonable value alongside the other defaults; 0 reproduces PLINK\n"
