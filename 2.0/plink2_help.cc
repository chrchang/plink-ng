...
"      fhat1: GCTA's variance-standardized relationship minus 1.\n"
"      fhat2: GCTA's excess-homozygosity estimator.  This is not the same as\n"
"             the f column: f is a ratio of sums over variants, while fhat2\n"
"             is a mean of per-variant ratios.\n"
"      fhat3: GCTA's correlation between uniting gametes.\n"
"    The default is maybefid,maybesid,hom,nobs,f.\n"
"    * fhat1/fhat2/fhat3 are the estimators PLINK 1.x reported from --ibc\n"
"      (Yang J, Lee SH, Goddard ME, Visscher PM (2011) GCTA: A Tool for\n"
"      Genome-wide Complex Trait Analysis), generalized to multiallelic\n"
"      variants: each per-variant term is written in terms of the sample's\n"
"      allele copy counts, which reduces to GCTA's formula at two alleles and\n"
"      keeps the expectation at 1 under Hardy-Weinberg equilibrium.\n"
"    * Unlike PLINK 1.x's --ibc, monomorphic variants are excluded from\n"
"      OBS_CT rather than counted with a zero contribution, so all the\n"
