...
"      are used.\n"
"    * Monomorphic variants stay in OBS_CT and contribute zero to all three\n"
"      estimates, matching PLINK 1.9 and GCTA.  A genotype that cannot occur\n"
"      at the given allele frequency makes the estimate infinite, which is how\n"
"      1.9 flags a --read-freq file that disagrees with the genotype data.\n"
"    Supported column sets are:\n"
"      maybefid: FID, if that column was present in the input.\n"
"      fid: Force FID column to be written even when absent in the input.\n"
"      (IID is always present, and positioned here.)\n"
