...
"    With either output type, the computation can be subdivided with --parallel.\n\n"
    ...
    HelpPrint("fast-epistasis\0epi1\0epi2\0gap\0", &help_ctrl, 1,
"  --fast-epistasis ['zs'] ['boost'] ['case-only'] ['no-ueki'] ['nop']\n"
"  --epi1 <p-value>\n"
"  --epi2 <p-value>\n"
"  --gap <kbs>\n"
"    Scan every pair of autosomal variants for an interaction, using PLINK\n"
"    1.07's allele-based test on the 3x3 joint genotype table.  The report is\n"
"    written to <output prefix>.epi.cc, with a per-variant summary alongside\n"
"    it in .epi.cc.summary.\n"
"    * The test compares the case and control log odds ratios, with the\n"
"      variance and empty-cell corrections from Ueki M, Cordell HJ (2012)\n"
"      Improved statistics for genome-wide interaction analysis.  'no-ueki'\n"
"      drops them for the original 1.07 statistic.\n"
"    * 'boost' replaces that test with the two-stage one of Wan X et al.\n"
"      (2010) BOOST: A fast approach to detecting gene-gene interactions in\n"
"      genome-wide case-control studies: pairs are screened with a\n"
"      closed-form approximation, and only those clearing --epi1 are then fit\n"
"      by iterative proportional fitting.  So --epi1 decides which pairs are\n"
"      tested at all rather than only which are printed, and its default is\n"
"      5e-6.  An empty genotype row or column costs two degrees of freedom\n"
"      instead of dropping the pair, so a DF column is added to the report.\n"
"      Cannot be combined with 'case-only' or 'no-ueki'.\n"
"    * 'case-only' uses the cases alone, writing .epi.co instead.  --gap then\n"
"      skips same-chromosome pairs closer than the given distance (default\n"
"      1000kb), since linkage disequilibrium rather than interaction explains\n"
"      those.\n"
"    * --epi1 (default 1e-4) is the reporting threshold, and --epi2 (default\n"
"      0.01) the threshold a pair must pass to count towards the summary's\n"
"      N_SIG.  'nop' drops the p-value column.\n"
