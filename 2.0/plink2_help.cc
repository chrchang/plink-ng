...
"    chrom/pos/ref/alt to the .lmendel[.zst] output file.\n\n"
    ...
    HelpPrint("homozyg\0homozyg-snp\0homozyg-kb\0homozyg-density\0homozyg-gap\0homozyg-het\0homozyg-window-snp\0homozyg-window-het\0homozyg-window-missing\0homozyg-window-threshold\0", &help_ctrl, 1,
...
"    Run-of-homozygosity reports, written to <output prefix>.hom,\n"
"    .hom.indiv and .hom.summary.\n"
"    * A scanning window of --homozyg-window-snp variants (default 50) is a\n"
"      hit for a sample when it holds at most --homozyg-window-het\n"
"      heterozygous (default 1) and --homozyg-window-missing missing calls\n"
"      (default 5).  A variant is eligible for a ROH when at least\n"
"      --homozyg-window-threshold of the windows covering it are hits\n"
"      (default 0.05).\n"
"    * Reported runs must contain at least --homozyg-snp variants (default\n"
"      100), span at least --homozyg-kb kilobases (default 1000), average at\n"
"      least one variant per --homozyg-density kb (default 50), and contain at\n"
"      most --homozyg-het heterozygous calls (unlimited by default).  Two\n"
"      consecutive variants more than --homozyg-gap kb apart (default 1000)\n"
...
"      be Zstd-compressed.\n"
"    * The \'group\'/\'group-verbose\' pool reports, \'consensus-match\',\n"
"      \'extend\', --homozyg-match and --pool-size are not implemented yet.\n"
"    Supported column sets are:\n"
"      Shared between .hom and .hom.indiv:\n"
"        maybefid: FID, if that column was present in the input.\n"
"        fid: Force FID column to be written even when absent in the input.\n"
"        (IID is always present, and positioned here.)\n"
"        maybesid: SID, if that column was present in the input.\n"
"        sid: Force SID column to be written even when absent in the input.\n"
"        maybepheno: Phenotype value, if a phenotype was loaded.\n"
"        pheno: Force phenotype column.\n"
"      Shared between .hom and .hom.summary[.zst]:\n"
"        chrom: Chromosome ID.\n"
"        pos: Base-pair coordinate(s).\n"
"      Specific to .hom:\n"
"        (ID1/ID2, the first and last variant IDs in the run, are always\n"
"        present, and positioned here.)\n"
"        kb: Run length in kilobases.\n"
"        nsnp: Number of variants in the run.\n"
"        density: Run length in kb, divided by the variant count.\n"
"        phom: Proportion of nonmissing calls in the run that are homozygous.\n"
"        phet: Proportion of nonmissing calls in the run that are heterozygous.\n"
"      Specific to .hom.indiv:\n"
"        nseg: Number of runs.\n"
