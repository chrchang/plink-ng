...
"    With either output type, the computation can be subdivided with --parallel.\n\n"
    ...
    HelpPrint("epistasis\0vif\0", &help_ctrl, 1,
"  --epistasis ['zs'] ['cols='<col set descriptor>]\n"
...
"      later.\n"
"    * Multiallelic variants are handled as major allele vs. the rest.\n"
...
"    The default is chrom,orbeta,se,tz,p.\n\n"
               );
    HelpPrint("epistasis-boost\0fast-epistasis\0", &help_ctrl, 1,
"  --epistasis-boost ['zs'] ['cols='<col set descriptor>]\n"
...
"        (BEST_CHISQ is always present, and positioned here.)\n"
"    The default is chrom,stat,df,p,nsig,ntot,prop.\n\n"
               );
