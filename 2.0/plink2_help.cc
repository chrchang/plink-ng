...
"    * When --extract-fcol-match is specified without --extract-fcol-substr, the\n"
"      value is checked for equality with the given strings, and kept iff one of\n"
"      them matches.  Similarly, --extract-fcol-mismatch without\n"
"      --extract-fcol-substr causes the variant to be kept iff the value matches\n"
"      none of the given strings.\n"
"    * When --extract-fcol-match and/or -mismatch are specified with\n"
"      --extract-fcol-substr, the variant is kept iff none of the\n"
"      --extract-fcol-mismatch substrings are contained in the value, and either\n"
"      --extract-fcol-match was unspecified or at least one of its substrings is\n"
"      contained.\n"
"    * Otherwise, the value is interpreted as a number, and the variant is kept\n"
"      if the number is in [<min>, <max>] (default min=0, max=DBL_MAX).\n"
...
"    With --extract-fcol-match-substr, the variant is kept if any of the\n"
"    --extract-fcol-match strings appear as substrings within the value string.\n"
              );
...
"                       sample ID match in this situation, add --strict-sid0.\n"
    ...
    HelpPrint("input-missing-phenotype\0\061\0missing-catname\0missing-phenotype\0", &help_ctrl, 0,
