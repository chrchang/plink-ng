...
"                                 ['vcf-dosage='<field>] ['vcf-info='<keys>]\n"
"                                 ['ref-first']\n"
"                                 ['bits='<#>] ['sample-v2']\n"
...
"                   'vcf-info=' takes a comma-separated list of INFO keys to\n"
"                   compute from the exported hardcalls; AC (count of each ALT\n"
"                   allele) and AN (total allele count) are currently\n"
"                   supported.  Counts follow the ploidy of the exported GT\n"
"                   field (e.g. a male chrX homozygous call counts once, a\n"
"                   male chrX het counts twice), and missing calls are\n"
"                   skipped.  .pvar INFO entries and header lines for the\n"
"                   requested keys are replaced.  This can't be combined with\n"
"                   vcf-dosage=DS-only.\n"
