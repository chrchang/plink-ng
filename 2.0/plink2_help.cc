...
"    * These estimates assume a homogeneous, randomly-mating population, and\n"
"      degrade badly when that does not hold.  --make-king{-table}'s\n"
"      KING-robust kinship estimator does not depend on that assumption, and\n"
"      is a better choice for relatedness filtering; --genome is here for\n"
"      compatibility with existing pipelines.\n"
"    * Allele frequencies come from founders unless --nonfounders is specified,\n"
"      and --read-freq is respected.\n"
"    * (Z0, Z1, Z2) is forced into the unit simplex unless \'unbounded\' is\n"
"      specified.  \'nudge\' instead pushes an estimate with Z2 > PI_HAT^2 onto\n"
...
"      maybesid: SID1/SID2, if that column was in the input.  Requires \'id\'.\n"
"      sid: Force SID1/SID2 even when SID was absent in the input.\n"
"      rt: Relationship type inferred from the pedigree columns: FS, HS, PO,\n"
"          OT within a family, UN across families.\n"
"      z: Z0, Z1 and Z2.\n"
"      pihat: PI_HAT.\n"
"      phe: 1 if both samples are cases, -1 if neither is, 0 otherwise.\n"
"      dst: IBS distance, 1 - (IBS1 + 2 * IBS0) / (2 * NSNP).\n"
"      nsnp: Number of variants considered (neither call missing).\n"
