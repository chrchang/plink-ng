...
"    outlier check on the PCs --pca just computed.  Requires --pca.\n"
...
"      of the PCs computed by --pca are used.\n"
...
"    * The nearest-neighbor search is a brute-force scan, so its cost grows\n"
