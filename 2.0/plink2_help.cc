...
"      New variant IDs are assigned as follows:\n"
...
"         correct.  Similarly, if joining with the 'vid-join' modifier, the new\n"
"         variant ID is set to the original IDs joined with the ';' character\n"
"         when none of the original IDs contain ';'.\n"
...
"                <cols=[col set descriptor]> <counts-cols=[col set descriptor]>\n"
...
"      machr2: Variant MaCH imputation quality (frequently labeled 'INFO').\n"
...
"          <ignore-dup-ids> <list-variants | list-variants-zs>\n"
...
"                       this situation, add --strict-sid0.\n"
    ...
    HelpPrint("input-missing-phenotype\01\0missing-catname\0missing-phenotype\0", &help_ctrl, 0,
