...
"      regression (see --mnl-ref).  There is no Firth fallback for them yet: a\n"
"      variant for which some category has zero A1 dosage is reported as NA\n"
"      (SEPARATION).\n"
...
"    <output prefix>.<pheno name>.glm.multinomial .\n"
...
"      row.\n"
"    * There is no Firth fallback yet.  When some category's samples all have\n"
"      zero A1 dosage, the maximum-likelihood estimate doesn't exist, and every\n"
"      row of the variant (LRT included) is NA with error code SEPARATION.\n"
"      This is common for rare variants and small categories: at MAF 1%, a\n"
"      38-sample category has no A1 allele about 47% of the time.\n"
...
"      a1freqcc, firth) are not reported.\n"
...
"      'interaction', 'firth', 'local-covar=' and permutation modifiers.\n"
               );
