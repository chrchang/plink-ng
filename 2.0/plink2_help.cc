...
"  --homozyg-match <min allelic match rate>\n"
...
"      be Zstd-compressed.\n"
"    * \'group\' additionally writes <output prefix>.hom.overlap, describing\n"
"      pools of mutually overlapping runs.  Within a pool, two runs are\n"
"      allelically matched when, over the variants where both samples are\n"
"      homozygous, at most 1 - --homozyg-match (default 0.95) of them carry\n"
"      different homozygous genotypes; the comparison region is the pair\'s\n"
"      own overlap, or the pool\'s consensus region under \'consensus-match\'.\n"
"      Runs are then grouped greedily, the one matching the most others\n"
"      becoming each group\'s reference, marked with \'*\' in the GRP column.\n"
"      Pools smaller than --pool-size (default 2) are skipped, and each pool\n"
"      ends with CON and UNION rows giving its consensus and union regions.\n"
"    * The \'group-verbose\' per-pool reports and \'extend\' are not implemented\n"
"      yet.\n"
"    Supported column sets are:\n"
