...
"      modifier).\n"
"      For now, this requires you to explicitly tell --glm to add the 'omitted'\n"
"      and 'a1freq' columns to its default output.  These two columns will be\n"
"      added to the default column set in a future build.\n"
