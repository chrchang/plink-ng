...
"       by more than --flip-scan-freq-diff (default 0.5) is reported as\n"
"       PROBLEM=Y on that alone.  This is the easy case, and it needs no LD.\n"
"    2. The remaining variants get the LD scan: the correlation with each\n"
"       nearby variant is computed separately in cases and in controls, and a\n"
"       variant with at least --flip-scan-min-neg (default 2) neighbors whose\n"
"       correlation changes sign is also reported as PROBLEM=Y.  That is the\n"
"       signature of a strand-ambiguous variant resolved differently in two\n"
"       separately-genotyped batches, which the frequency comparison misses.\n"
"    * Variants flagged in step 1, and variants whose major-allele frequency\n"
...
"        altfreq: ALT allele frequency over both groups.\n"
...
"                                 variant is left out of the LD scan\n"
"                                 (default 0.9).\n"
