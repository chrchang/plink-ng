...
"  --homozyg-min-af <min allele frequency>\n"
...
"    * Variants with minor allele frequency below --homozyg-min-af (default\n"
"      0.05) are excluded, since rare variants are homozygous in nearly\n"
"      everyone and pad out runs the same way.  Set it to 0 for PLINK 1.x\n"
"      behavior.\n"
