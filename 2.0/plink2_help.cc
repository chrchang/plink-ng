...
"    With either output type, the computation can be subdivided with --parallel.\n\n"
    ...
    HelpPrint("ld-score\0ld-score-window\0ld-score-window-kb\0ld-score-window-cm\0", &help_ctrl, 1,
...
"    * Only founders are considered, as with --r2-unphased.\n"
...
"    * Multiallelic variants and haploid chromosomes are skipped, and\n"
"      monomorphic variants are reported as NA.\n"
"    Supported column sets are:\n"
"      chrom: Chromosome ID.\n"
"      pos: Base-pair coordinate.\n"
"      (ID is always present, and positioned here.)\n"
"      nobs: Number of variants in the window, including this one.\n"
