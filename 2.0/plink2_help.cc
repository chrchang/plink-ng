...
"      written to <output prefix>.<phenotype name>.glm.multinomial.\n"
...
"        Likelihood ratio and Wald statistics are then NA, with error code\n"
"        SEPARATION.\n"
"        UNFINISHED marks a fit that did not converge; its statistics are NA as\n"
"        well.\n"
