...
"    The default is chrom,maybeprovref,ax,gcounts,hetfreq,sexaf,p.\n\n"
    ...
    HelpPrint("tdt\0", &help_ctrl, 1,
"  --tdt ['zs'] [{'exact' | 'exact-midp'}] [{'cols='<column set descriptor>}]\n"
"    Transmission disequilibrium test, given a case/control phenotype and\n"
"    pedigree information.  For each variant, the alleles heterozygous parents\n"
"    transmit to their affected children are counted; under the null the two\n"
"    alleles are transmitted equally often.\n"
"    * Both parents must be present: with one of them unobserved, what the\n"
"      other transmitted is not identifiable, so duos are not used.\n"
"    * A trio is skipped at a variant when any of its three genotypes is\n"
"      missing, and when its genotypes are Mendel-inconsistent, since the\n"
"      transmitted allele is then undetermined.\n"
"    * T and U count the ALT allele, reported in the A1 column.\n"
"    * The p-value is based on a chi-square test unless \'exact\' or\n"
"      \'exact-midp\' requests the exact binomial test.  CHISQ is omitted when\n"
"      an exact test is used.\n"
"    * Only diploid chromosomes are considered; chrX support is not\n"
"      implemented yet, and neither are the \'perm\'/\'mperm=\', \'set-test\' and\n"
"      \'poo\' modifiers.\n"
"    Supported column sets are:\n"
"      chrom: Chromosome ID.\n"
"      pos: Base-pair coordinate.\n"
...
"                    provisional, when at least one of the latter is present.\n"
"      provref: Force provref column even if all-\'N\'.\n"
"      a1: The allele T and U count, i.e. ALT.\n"
"      t: Transmitted count.\n"
"      u: Untransmitted count.\n"
"      nobs: T + U, the number of informative transmissions.\n"
"      or: Odds ratio, T/U.\n"
"      chisq: Chi-square statistic, (T - U)^2 / (T + U).\n"
"      p: p-value.\n"
"    The default is chrom,pos,ref,alt,maybeprovref,a1,t,u,or,chisq,p.\n\n"
              );
