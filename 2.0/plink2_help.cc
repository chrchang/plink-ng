...
"      omnibus test per variant of the additive A1 dosage against all K\n"
"      phenotype levels, on K-1 degrees of freedom.  Results are written to\n"
"      <output prefix>.<phenotype name>.glm.multinomial.\n"
...
"      * When the dosages in some level all lie at or below (or at or above)\n"
"        those of every other level, e.g. when a level has no copy of one\n"
"        allele, the maximum-likelihood estimate does not exist.  Likelihood\n"
"        ratio and Wald statistics are then NA, with error code SEPARATION.\n"
...
"        of the (A1, other allele) x level allele count table under\n"
"        independence.  Asymptotic p-values are unreliable when it is small\n"
"        (Cochran's rule asks for at least 5).\n"
"      * Only the additive model is supported for now, without --parameters,\n"
"        --tests, local covariates, or permutation.  Multiallelic variants are\n"
"        skipped.\n"
...
"    reports the chi-square statistic and its degrees of freedom.\n\n"
               );
