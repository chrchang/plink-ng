...
pglerr_t ld_console(const uintptr_t* variant_include, const chr_info_t* cip, char** variant_ids, const uintptr_t* variant_allele_idxs, const uintptr_t* founder_info, const uintptr_t* sex_male, char** ld_flag_varids, uint32_t variant_ct, uint32_t raw_sample_ct, uint32_t founder_ct, uint32_t hwe_midp, pgen_reader_t* simple_pgrp, char* outname, char* outname_end);
