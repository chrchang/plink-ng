...
FLAGSET_DEF_START()
  ...
  kfScoreColMaybesid = (1 << 6),
  kfScoreColSid = (1 << 7),
  kfScoreColPheno1 = (1 << 8),
  kfScoreColPhenos = (1 << 9),
  kfScoreColNmissAllele = (1 << 10),
  kfScoreColDenom = (1 << 11),
  kfScoreColDosageSum = (1 << 12),
  kfScoreColScoreAvgs = (1 << 13),
  kfScoreColScoreSums = (1 << 14),
