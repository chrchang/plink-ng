...
FLAGSET_DEF_START()
  ...
  kfScoreColMaybesid = (1 << 7),
  kfScoreColSid = (1 << 8),
  kfScoreColPheno1 = (1 << 9),
  kfScoreColPhenos = (1 << 10),
  kfScoreColNmissAllele = (1 << 11),
  kfScoreColDenom = (1 << 12),
  kfScoreColDosageSum = (1 << 13),
  kfScoreColScoreAvgs = (1 << 14),
  kfScoreColScoreSums = (1 << 15),
