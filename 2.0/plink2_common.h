...
FLAGSET64_DEF_START()
  ...
  kfMiscMafSucc = (1 << 16),
  kfMiscGenoDosage = (1 << 17),
  kfMiscGenoHhMissing = (1 << 18),
  kfMiscMindDosage = (1 << 19),
  kfMiscMindHhMissing = (1 << 20),
  kfMiscGenotypingRateDosage = (1 << 21),
  kfMiscSetMissingVarIds = (1 << 22),
  kfMiscChrOverrideCmdline = (1 << 23),
  kfMiscChrOverrideFile = (1 << 24),
  kfMiscNewVarIdOverflowMissing = (1 << 25),
  kfMiscNewVarIdOverflowTruncate = (1 << 26),
  kfMiscRequirePheno = (1 << 27),
  kfMiscRequireCovar = (1 << 28),
  kfMiscCatPhenoFamily = (1 << 29),
  kfMiscRefAlleleForce = (1 << 30),
  kfMiscAlt1AlleleForce = (1U << 31),
  ...
  kfMiscIidSid = (1LLU << 40),
  kfMiscPhenoIidOnly = (1LLU << 41),
  kfMiscCovarIidOnly = (1LLU << 42),
  kfMiscAllowBadLd = (1LLU << 43)
