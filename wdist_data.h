...
int32_t update_marker_cms();

int32_t update_marker_names();

int32_t update_marker_alleles();
...
/*
int32_t sort_and_write_bim(int32_t** map_reverse_ptr, FILE* mapfile, int32_t map_cols, FILE** bimfile_ptr, char* outname, char* outname_end, uintptr_t unfiltered_marker_ct, uintptr_t* marker_exclude, uintptr_t marker_ct, uintptr_t max_marker_id_len, int32_t species, char* marker_alleles, uintptr_t max_marker_allele_len, Two_col_params* update_chr, Two_col_params* update_map);
*/
